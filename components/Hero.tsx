...
export function Hero({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="relative px-6 pb-24 pt-16 md:pb-32 md:pt-20">
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-16 md:grid-cols-12 md:gap-10">
        {/* left column: copy */}
