...
const COPY = {
  vi: {
    ...
    lead: "Để lại email, mình gửi ngay bộ tài liệu từ vựng + mã giảm giá 20% cho Vô chi Pro.",
    ...
    submitting: "Đang gửi...",
    close: "Đóng",
    okTitle: "Đã gửi rồi nhé 📬",
    okLead: "Kiểm tra hộp thư (cả mục Quảng cáo/Spam) để lấy tài liệu và mã giảm giá.",
  ...
  en: {
    title: "Get the free study pack",
    lead: "Drop your email and we'll send the vocabulary pack plus 20% off Vô chi Pro.",
    ...
    close: "Close",
    okTitle: "On its way 📬",
    okLead: "Check your inbox (and the Promotions/Spam tab) for the pack and your discount code.",
