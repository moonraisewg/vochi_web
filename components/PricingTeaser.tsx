    ...
    plans: [
      {
        ...
        features: [
          ...
          "Học thử 100 từ đầu tiên trong kho 5.300 từ",
          "Lịch ôn tự động theo trí nhớ của bạn",
          "Offline, dữ liệu nằm trên máy bạn",
          "Có cho macOS và Windows",
    ...
    plans: [
      {
        ...
        features: [
          ...
          "Try the first 100 words from a 5,300-word library",
          "Reviews scheduled to your memory",
...
export function PricingTeaser({ lang }: { lang: Lang }) {
  ...
  return (
    <section id="pricing" className="relative px-6 py-8 md:py-12">
